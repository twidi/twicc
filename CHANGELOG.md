...
- **Codex runtime** — Update from v0.150.1 to v0.153.2 (migration of existing sessions to Codex's new rollout format; a session stays unavailable until its rebuild finishes).
