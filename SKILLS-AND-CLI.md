...
**Deprecated until 2026-10-01; from that date it refuses to run** (exit `64`, an error naming the replacement). Until then it works as before (`--paginated` included), with a notice naming the replacement. Replacements:
...
**Deprecated until 2026-10-01; from that date it refuses to run** (exit `64`, an error naming the replacement). Replacements:
