...
def _session_wait(
    ...
    since: str = typer.Option(
        ...
        help=(
            ...
            "lower. A line with no timestamp is not a boundary; one below "
            "the boundary is not re-scanned. ISO 8601 — '2026-09-19T05:38:20+00:00', exactly what "
            ...
            "session starts the wait above the first stamped line."
        ),
    ),
