...
from twicc.cli._output import emit_error, emit_list, listing_cutover_passed, resolve_limit
...
def main(
    *,
    ...
    django.setup()
    # No pagination notice: it would announce a shape for the date this command
    # stops working (docs/plans/2026-09-23-process-commands-removal-design.md).
    paginated = paginated or listing_cutover_passed()
