...
CODEX_COMPUTE_VERSION = 47  # 47: a multi-agent v2 NEW_TASK is the subagent's opening user message (46: multi-agent v2 subagent linkage — sub_agent_activity spawn event + FINAL_ANSWER termination, 45: hide repeated Goal continuation prompts and recover lifecycle completion from structured Goal-tool results, 44: /plan support)
